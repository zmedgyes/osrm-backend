...
public:
    ...
    explicit NodeBasedEdge(NodeID s, NodeID t, NodeID n, EdgeWeight sp, float w, bool f, bool b, short ty, bool ra, bool ig, bool ar) :
...
//        _turnInstruction(myEdge.data.turnInstruction)
    ...
    explicit EdgeBasedEdge(NodeID s, NodeID t, NodeID v, EdgeWeight sp, float w, bool f, bool b) :
